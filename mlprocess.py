...
def cv_multi_report(X_train_dic, y_train, out_names, model=None, balancing=False, modelname=None, spec_params=None,
    ...
    for name in tqdm(out_names):
        ...
        if spec_params:
            ...
            if modelname[name] == "SVC":
            ...
            elif modelname[name] == "ADA":
                model_temp = AdaBoostClassifier(n_estimators=100, random_state=random_state)
                model_temp.set_params(
                                      algorithm=spec_params[name]["adaboostclassifier__algorithm"],
                                      learning_rate=spec_params[name]["adaboostclassifier__learning_rate"],
                                      n_estimators=spec_params[name]["adaboostclassifier__n_estimators"])
                ...
                model_ada = AdaBoostClassifier(n_estimators=100, random_state=random_state)
                ...
                model_ada.set_params(algorithm=spec_params[2][name]["adaboostclassifier__algorithm"],
                                      learning_rate=spec_params[2][name]["adaboostclassifier__learning_rate"],
                                      n_estimators=spec_params[2][name]["adaboostclassifier__n_estimators"])
                model_xgb.set_params(colsample_bytree=spec_params[3][name]["xgbclassifier__colsample_bytree"],
                                     eta=spec_params[3][name]["xgbclassifier__eta"],
                                     gamma=spec_params[3][name]["xgbclassifier__gamma"],
                                     max_depth=spec_params[3][name]["xgbclassifier__max_depth"],
                                     min_child_weight=spec_params[3][name]["xgbclassifier__min_child_weight"],
                                     subsample=spec_params[3][name]["xgbclassifier__subsample"])
